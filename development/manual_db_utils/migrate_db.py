...
from development.manual_db_utils.generate_sample_db import add_needs, add_labels
...
import server
from server.models import Student, Guardian, Payment, Course, Label, Schedule
                ...
                for s2 in course.schedules:
                    if s2.is_base:
                        ...
                        if (
                            ...
                            server.db.session.delete(schedule)
