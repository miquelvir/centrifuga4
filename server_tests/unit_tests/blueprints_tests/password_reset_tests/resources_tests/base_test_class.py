...
class TestPasswordResetPost(WithApp):
    def setUp(self):
        ...
        self.password_reset_service_mock.trigger_event_user_password_reset_request = Mock()
        self.password_reset_service_mock.trigger_event_user_password_reset_redeem = Mock()
        self.password_reset_service_mock.get_user_from_email.return_value = self.sample_user
    ...
    def override_all(self):
        ...
        with self.override_recaptcha_service() as ctx1:
            with self.app.container.password_reset_service.override(self.password_reset_service_mock) as ctx2:
                yield ctx1, ctx2
