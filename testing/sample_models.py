...
def powerful_bob():
    return (
        User(
            id="6f82c87e-b8a5-47de-ba66-759c9f9401da",
            name="bob",
            surname1="stuart",
            surname2="mill",
...
def reader_anne():
    return (
        User(
            id="13efe66b-4c0c-4ac3-a036-397994acd519",
            name="anne",
            surname1="mathias",
            surname2="aria",
...
def editor_ezequiel():
    return (
        User(
            id="b4c06ee0-79b1-4073-be5a-1a668027d985",
            name="ezequiel",
            surname1="more",
            surname2="stuart",
            email="ezi@gmail.com",
...
def deleter_mer():
    return (
        User(
            id="cd177dba-77df-4205-b63f-df06e0352626",
            name="mer",
            surname1="green",
            surname2="mill",
            email="mer@gmail.com",
...
def secretary_lucas():
    return (
        User(
            id="540626a9-591f-42f5-8434-42c1e7590377",
            name="lucas",
            surname1="lithium",
            surname2="ore",
...
def guardian_mary():
    return Student(
        id="b45b8930-cd13-4e55-9f51-e09f66bb80fc",
        name="mary",
        surname1="li",
        surname2="van goh",
...
def guardian_paul():
    return Student(
        id="d4cabb71-e467-43e4-9849-68c86032d6af",
        name="paul",
        surname1="gio",
        surname2="go",
...
def course_clarinet():
    return Course(id="d1db7ed7-2e6d-4451-83eb-855b650131c8", name="clarinet 101")


def course_piano():
    return Course(id="9e045df3-91eb-4ac6-b191-0026c7e066e6", name="piano 101")


def teacher_ester():
    return Teacher(
        id="e4acbe5b-289b-4e9e-9f3f-fe17cb4cbaac",
        name="ester",
        surname1="bonal",
        surname2="penyagut",
...
def teacher_paco():
    return Teacher(
        id="7a346115-7994-4d16-9382-287e735c2fd3",
        name="paco",
        surname1="vidal",
        surname2="francesc",
...
def student_nerea():
    return Student(
        id="117b4e24-9523-42a3-b5e2-bacf1b292fef",
        name="nerea",
        surname1="sastrum",
        surname2="ferny",
